...
services_data = [
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Time-Consuming Tasks", "description": "Employees spend hours on manual data entry and repetitive approvals." },
        { "title": "High Error Rates", "description": "Human intervention in data transfers leads to costly mistakes and rework." },
        { "title": "Lack of Visibility", "description": "Management lacks clear oversight into process status and bottlenecks." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Overwhelmed Support", "description": "Human agents are bogged down by repetitive, simple questions." },
        { "title": "Delayed Responses", "description": "Customers face long wait times during off-hours or peak seasons." },
        { "title": "Lost Opportunities", "description": "Potential leads bounce off your website because they can't find answers quickly." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Data Silos", "description": "Critical information is trapped in disconnected departmental software." },
        { "title": "Inaccurate Records", "description": "Duplicate entries and outdated files lead to poor decision-making." },
        { "title": "Security Risks", "description": "Lack of centralized governance exposes sensitive data to breaches." }
      ],
      "howWeHelp": [
  ...
  {
    "slug": "mis-systems-google-sheets",
    "icon_name": "FiTable",
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Spreadsheet Chaos", "description": "Teams struggle with overwritten data, broken formulas, and version control issues." },
        { "title": "High SaaS Costs", "description": "Paying exorbitant monthly fees for specialized software that teams barely use." },
        { "title": "Manual Reporting", "description": "Consolidating monthly figures requires hours of tedious copy-pasting." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Lost Documents", "description": "Employees waste time searching through chaotic shared drives for policies and assets." },
        { "title": "Poor Communication", "description": "Important company updates get buried in email threads or ignored in chat apps." },
        { "title": "Access Issues", "description": "Managing permissions for scattered files is an administrative nightmare." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Data Overload", "description": "Stakeholders are overwhelmed by raw numbers lacking context." },
        { "title": "Delayed Reporting", "description": "Compiling weekly performance reports takes days of manual effort." },
        { "title": "Fragmented Metrics", "description": "Advertising, sales, and web data live in completely different systems." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Low Conversion Rates", "description": "Traffic arrives but leaves without engaging or purchasing." },
        { "title": "Poor Performance", "description": "Slow loading speeds frustrate users and hurt search engine rankings." },
        { "title": "Outdated Design", "description": "A non-responsive layout that looks broken on mobile devices." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Rigid Software", "description": "Off-the-shelf tools force you to change your processes to fit their limitations." },
        { "title": "Scaling Bottlenecks", "description": "Current systems crash or slow down under heavy user traffic." },
        { "title": "Complex Access Needs", "description": "Inability to properly manage multi-tier user roles and permissions." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Limited Reach", "description": "Failing to engage the rapidly growing mobile-first consumer segment." },
        { "title": "Disjointed Experience", "description": "Mobile websites lack the smooth interactions and hardware features of apps." },
        { "title": "Disconnected Teams", "description": "Field workers struggle to access or log data without a stable desktop." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "On-Site Liabilities", "description": "Maintaining physical servers is costly, vulnerable, and prone to hardware failure." },
        { "title": "Rigid Scaling", "description": "Adding more capacity for seasonal surges requires expensive new hardware purchases." },
        { "title": "Localized Access", "description": "Remote employees struggle to access core systems securely from out-of-office networks." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Disconnected Tools", "description": "Essential software platforms operate in isolation, lacking native connectivity." },
        { "title": "Manual Data Entry", "description": "Staff must manually copy information from one system to another." },
        { "title": "Sync Errors", "description": "Poor integrations lead to dropped data or duplicate records." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Low Email Open Rates", "description": "Important announcements and promotions are ignored in crowded inboxes." },
        { "title": "Support Bottlenecks", "description": "Customers wait too long for answers to basic questions." },
        { "title": "Notification Delays", "description": "Clients are unaware of order statuses or appointment updates." }
      ],
      "howWeHelp": [
  ...
  },
  {
    ...
    "detailContent": {
      ...
      "problems": [
        { "title": "Lost Prospects", "description": "Potential customers disengage because of infrequent or irrelevant follow-ups." },
        { "title": "Abandoned Purchases", "description": "Users add items to carts or start forms but never finalize the action." },
        { "title": "Generic Batching", "description": "Sending the same blast to everyone hurts deliverability and annoys subscribers." }
      ],
      "howWeHelp": [
...
async def run_seed():
    ...
    # Check if there are services already. Let's completely drop or update.
    # Since Phase 1 might have some dummy services, let's clear them out.
    await services_col.delete_many({})
    print("Cleared existing services collection.")

    for sv in services_data:
        sv["_id"] = str(ObjectId())
        sv["created_at"] = datetime.utcnow()
        sv["updated_at"] = datetime.utcnow()
        
        await services_col.insert_one(sv)
        print(f"Inserted: {sv['title']} -> slug: {sv['slug']}")
