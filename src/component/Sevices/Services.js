            ...
            <div className="row justify-content-center align-items-center">
              ...
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${dataManagementImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Our data management services ensure that your data is organized, secure, and easily accessible. We offer solutions tailored to your needs, from data cleaning and storage to integration and migration.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${dataAnalysisImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Transform raw data into meaningful insights with our data analysis and management services. We use cutting-edge techniques to analyze your data, helping you uncover trends and patterns that drive business growth.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${reportingImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Stay informed with our comprehensive reporting solutions. We provide detailed and customizable reports that give you a clear view of your business performance, enabling you to make data-driven decisions.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${misImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Our MIS services deliver real-time information to manage your business operations effectively. We design and implement systems that provide critical data at your fingertips.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${salesAnalysisImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Boost your sales strategy with our sales analysis services. We help you understand your sales data, identify opportunities, and improve your sales performance.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${whatsappImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Enhance your customer communication with our WhatsApp integration and automation solutions. We streamline your messaging processes, ensuring timely and effective engagement with your clients.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${emailImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Optimize your email marketing campaigns with our email integration and automation services. We help you create, send, and track emails, maximizing your outreach and engagement.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${smssImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Improve your customer outreach with our SMSS solutions. We enable efficient and effective SMS communication for marketing, notifications, and customer support.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${pmsImg})`, backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center` }}>
                  ...
                  <p>Our production management system (PMS) services streamline your production processes, enhancing efficiency and productivity. We provide tools for planning, monitoring, and controlling your production activities.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6 col-12 my-2">
                <div className="service-section mx-1" style={{ backgroundImage: `url(${flowchartImg})` , backgroundRepeat: `no-repeat`, backgroundSize:`cover`, backgroundPosition: `center`}}>
                  ...
                  <p>Visualize and optimize your processes with our flowchart monitoring system. We help you create, track, and improve workflows, ensuring smooth and efficient operations.</p>
                </div>
              </div>
            </div>
            </div>
